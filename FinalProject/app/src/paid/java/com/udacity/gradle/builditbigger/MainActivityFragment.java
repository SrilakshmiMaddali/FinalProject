...
public class MainActivityFragment extends Fragment {
    ...
    private static final int DISPLAY_REQUEST_CODE = 1002;

    @BindView(R.id.button_tell_joke)
    Button mButtonTellJoke;
    @BindView(R.id.progress_bar)
    ProgressBar mProgressBar;
    @BindView(R.id.statusmessage_tv)
    ...
    private void beginObserving() {
        ...
        mViewModel.addMainViewOwner(this, mJokeObserver);
    ...
    private void tellJoke(JokeData jokeData) {
        ...
        Intent displayThingActivity = new Intent(getContext(), JokeDisplay.class);
        displayThingActivity.putExtra(JokeDisplay.JOKE_KEY, sb.toString());

        startActivityForResult(displayThingActivity, DISPLAY_REQUEST_CODE);
    }
